...
const CACHE_NAME = "adventure-guide-v3.3.0-20260806a";
...
const APP_SHELL = [
  ...
  "./assets/css/styles.css?v=3.3.0-20260806a",
  "./assets/js/app.js?v=3.3.0-20260806a",
  "./assets/js/i18n.js",
  "./assets/js/pagination.js",
  "./assets/js/pwa.js",
  "./assets/js/search.js",
  "./assets/js/semantic-worker.js?v=3.3.0-20260806a",
  ...
  "./data/categories.json?v=3.3.0-20260806a",
  "./data/learning-paths.json?v=3.3.0-20260806a",
  "./data/semantic-index.f32?v=3.3.0-20260806a",
  "./data/semantic-index.json?v=3.3.0-20260806a",
  "./data/shorts.json?v=3.3.0-20260806a",
  "./data/site-config.json?v=3.3.0-20260806a",
  "./data/synonyms.json?v=3.3.0-20260806a",
  "./data/travel-guides.json?v=3.3.0-20260806a",
  "./data/videos.json?v=3.3.0-20260806a"
