# Changelog — גרסת מסמך 3.4.0

## 3.4.0 — 2026-08-06

- נוספו 14 סרטוני הדרכה מלאים של Chris Birch וקצר אחד, לאחר אימות מקור ובדיקת תוכן ממוקדת לרכיבת Adventure.
- 287 מועמדים ייחודיים מופו ו־66 נבדקו עם מטא־דאטה מפורטת; סרטוני Enduro בלבד, תדמית, רכיבת ראווה ומוצר הוצאו.
- נוסף מסלול Chris Birch Adventure Masterclass בן 8 שלבים.
- המאגר הציבורי כולל כעת 425 סרטונים מלאים ו־153 קצרים, 578 פריטים בסך הכול ו־18 מסלולי לימוד.
- גרסת האתר, ה־PWA, הסכמה וה־Standalone הועלתה ל־3.4.0.

## 3.3.0 — 2026-08-06

- נאספו מחדש מטא־דאטה ציבורי וכתוביות זמינות עבור 795 הקצרים שהוסגרו ב־3.2.0, ללא הורדת וידאו או אודיו.
- 180 מועמדים מאוזני־קטגוריה נבדקו בשתי נקודות זמן מתוך נגן Shorts חי; 152 פורסמו ו־28 הוסרו עקב פרסום ממוקד, אי־התאמה או ספק.
- תוקנו סיווגים חזותיים שגויים ונחסמו במפורש התאמות `GPS Tire` ו־deer rut.
- 114 שלבי לימוד כוללים 301 הפניות לקצרים תואמי־קטגוריה.
- גרסת האתר, ה־PWA, הסכמה וה־Standalone הועלתה ל־3.3.0; המאגר הציבורי כולל 563 פריטים.
